...
class Users  extends BaseController
{
	...
	public function index()
	{
		...
		// количество результатов на странице $per_page
		$per_page = 10;
		// имена столбцов из нашей базы данных $columns
	...
	{
		$fileds = [];
		$fileds['u_firstname'] = ['label' => 'First Name'];
		$fileds['u_lastname'] = ['label' => 'Last Name'];
		return $fileds;
	}
}
